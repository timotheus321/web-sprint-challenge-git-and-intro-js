...
function removeArtist(artists, number) {
 ...
 if (number >= 0 && number < copiedArtists.length) {
    copiedArtists.splice(number, 1);
 }
...
console.log('task 6:', addArtist(artists, 'John Doe', '1988-2022', 'rock', 'American', 'bio'));
